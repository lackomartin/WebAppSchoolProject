...
<body bgcolor="#e8e8e8">
   ...
   <div class="menu">
    ...
    <div class="body">
     <h1>Popis svih doktora u bolnici.</h1>
      ...
      <div class="data_space">
        ...
        <?php
         ...
         $doktor = mysqli_query($db, "SELECT * FROM Doktor");
         ...
         <div class='data_row2'>
          ...
          <a href='detalji_doktor.php?id=".$row['id']."'><div class='detalji'>Pogledajte detalje</div></a>
        </div>";
