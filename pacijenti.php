...
<body bgcolor="#e8e8e8">
   ...
   <div class="menu">
    ...
    <div class="body">
     <h1>Popis svih pacijenata u bolnici.</h1>
      ...
      <div class="data_space">
        ...
        <?php
         ...
         $pacijent = mysqli_query($db, "SELECT * FROM Pacijent");
         ...
         <div class='data_row2'>
          ...
          <a href='detalji_pacijent.php?id=".$row['id']."'><div class='detalji'>Pogledajte detalje</div></a>
        </div>";
